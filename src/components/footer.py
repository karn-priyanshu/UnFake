        ...
        <div class="footer-content">
            <div class="footer-column">
                ...
                <div class="social-icons">
                    <a href="https://github.com/karn-priyanshu/UnFake" target="_blank">
                    ...
                    <a href="https://www.linkedin.com/in/priyanshu-karn/" target="_blank">
            ...
            <div class="footer-column">
                <h3>Resources</h3>
                <ul>
                    <li><a href="https://github.com/karn-priyanshu/UnFake" target="_blank">GitHub Repository</a></li>
                    <li><a href="https://github.com/karn-priyanshu/UnFake/blob/main/README.md" target="_blank">Documentation</a></li>
                    <li><a href="https://github.com/karn-priyanshu/UnFake/blob/main/README.md#%EF%B8%8F-setup" target="_blank">Setup Guide</a></li>
                    <li><a href="https://github.com/karn-priyanshu/UnFake" target="_blank">Demo</a></li>
                    <li><a href="https://github.com/karn-priyanshu/UnFake/pulls" target="_blank">Contributing</a></li>
                    <li><a href="https://github.com/karn-priyanshu/UnFake/blob/main/LICENSE" target="_blank">License</a></li>
                </ul>
            </div>
            <div class="footer-column">
                <h3>Stay Updated</h3>
